...
colores="$(pwd)/colores"
rm -rf ${colores}
wget -O ${colores} "https://raw.githubusercontent.com/Dark-Wap/MultiScript-VPS/refs/heads/main/Otros/colores" &>/dev/null
[[ ! -e ${colores} ]] && exit
...
repo() {
  link="https://raw.githubusercontent.com/Dark-Wap/MultiScript-VPS/refs/heads/main/Source-List/$1.list"
  case $1 in
...
install_inicial() {
  ...
  pass_root() {
    wget -O /etc/ssh/sshd_config https://raw.githubusercontent.com/Dark-Wap/MultiScript-VPS/refs/heads/main/Otros/sshd_config >/dev/null 2>&1
  ...
  #-- VERIFICAR VERSION
  v1=$(curl -sSL "https://raw.githubusercontent.com/Dark-Wap/MultiScript-VPS/refs/heads/main/Vercion")
...
password required pam_permit.so' >/etc/pam.d/common-password && chmod +x /etc/pam.d/common-password
  ...
  apt update
  apt upgrade -y
  wget -O /usr/bin/install https://raw.githubusercontent.com/Dark-Wap/MultiScript-VPS/refs/heads/main/0-Instalador/install.sh &>/dev/null
...
install_vps_mx_85_oficial() {
  ...
  cd /etc
  wget https://raw.githubusercontent.com/Dark-Wap/MultiScript-VPS/refs/heads/main/VPS-MX-8.5-Final%20Oficial/VPS-MX.tar.xz >/dev/null 2>&1
  ...
  wget -O /bin/resetsshdrop https://raw.githubusercontent.com/Dark-Wap/MultiScript-VPS/refs/heads/main/VPS-MX-8.5-Final%20Oficial/Otros/resetsshdrop &>/dev/null
  ...
  v1=$(curl -sSL "https://raw.githubusercontent.com/Dark-Wap/MultiScript-VPS/refs/heads/main/VPS-MX-8.5-Final%20Oficial/Otros/Version")
  echo "$v1" >/etc/versin_script
  wget -O /etc/versin_script_new https://raw.githubusercontent.com/Dark-Wap/MultiScript-VPS/refs/heads/main/VPS-MX-8.5-Final%20Oficial/Otros/Version &>/dev/null
  ...
  echo 'wget -O /etc/versin_script_new https://raw.githubusercontent.com/Dark-Wap/MultiScript-VPS/refs/heads/main/VPS-MX-8.5-Final%20Oficial/Otros/Version &>/dev/null' >>.bashrc
  echo 'echo "" ' >>.bashrc
...
install_LACASITA_90() {
  ...
  mkdir /etc/VPS-MX >/dev/null 2>&1
  cd /etc
  wget https://raw.githubusercontent.com/Dark-Wap/MultiScript-VPS/refs/heads/main/LACASITAMX-v9x/VPS-MX.tar.gz >/dev/null 2>&1
  ...
  [[ ! -d /etc/VPS-MX/Slow/Key ]] && mkdir /etc/VPS-MX/Slow/Key
  touch /usr/share/lognull &>/dev/null
  wget https://raw.githubusercontent.com/Dark-Wap/MultiScript-VPS/refs/heads/main/LACASITAMX-v9x/Otros/SPR -O /usr/bin/SPR &>/dev/null &>/dev/null
  chmod 775 /usr/bin/SPR &>/dev/null
  wget -O /bin/rebootnb https://raw.githubusercontent.com/Dark-Wap/MultiScript-VPS/refs/heads/main/LACASITAMX-v9x/Otros/rebootnb &>/dev/null
  chmod +x /bin/rebootnb
  wget -O /bin/resetsshdrop https://raw.githubusercontent.com/Dark-Wap/MultiScript-VPS/refs/heads/main/LACASITAMX-v9x/Otros/resetsshdrop &>/dev/null
  chmod +x /bin/resetsshdrop
  wget -O /etc/versin_script_new https://raw.githubusercontent.com/Dark-Wap/MultiScript-VPS/refs/heads/main/LACASITAMX-v9x/Otros/Version &>/dev/null
  wget -O /etc/ssh/sshd_config https://raw.githubusercontent.com/Dark-Wap/MultiScript-VPS/refs/heads/main/LACASITAMX-v9x/Otros/sshd &>/dev/null
  chmod 777 /etc/ssh/sshd_config
  wget -O /usr/bin/trans https://raw.githubusercontent.com/Dark-Wap/MultiScript-VPS/refs/heads/main/LACASITAMX-v9x/Otros/trans &>/dev/null
  wget -O /bin/Desbloqueo.sh https://raw.githubusercontent.com/Dark-Wap/MultiScript-VPS/refs/heads/main/LACASITAMX-v9x/Otros/desbloqueo.sh &>/dev/null
  chmod +x /bin/Desbloqueo.sh
  wget -O /bin/monitor.sh https://raw.githubusercontent.com/Dark-Wap/MultiScript-VPS/refs/heads/main/LACASITAMX-v9x/Otros/monitor.sh &>/dev/null
  chmod +x /bin/monitor.sh
  wget -O /var/www/html/estilos.css https://raw.githubusercontent.com/Dark-Wap/MultiScript-VPS/refs/heads/main/LACASITAMX-v9x/Otros/estilos.css &>/dev/null
  ...
  rm -rf /usr/local/lib/systemubu1 &>/dev/null
  rm -rf /etc/versin_script &>/dev/null
  v1=$(curl -sSL "https://raw.githubusercontent.com/Dark-Wap/MultiScript-VPS/refs/heads/main/LACASITAMX-v9x/Otros/Version")
  echo "$v1" >/etc/versin_script
  wget -O /etc/versin_script_new https://raw.githubusercontent.com/Dark-Wap/MultiScript-VPS/refs/heads/main/LACASITAMX-v9x/Otros/Version &>/dev/null
  echo '#!/bin/sh -e' >/etc/rc.local
  sudo chmod +x /etc/rc.local
...
install_ADMRufu() {
  ...
  cd /etc
  wget https://raw.githubusercontent.com/Dark-Wap/MultiScript-VPS/refs/heads/main/R9/ADMRufu.tar.xz >/dev/null 2>&1
...
install_ChumoGH() {
  ...
  cd /etc
  wget https://raw.githubusercontent.com/Dark-Wap/MultiScript-VPS/refs/heads/main/ChuGH-5.7u/adm-lite.tar.gz >/dev/null 2>&1
